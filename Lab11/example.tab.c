...
static const char *const yytname[] =
{
  ...
  "T_MINUS", "T_MUL", "T_DIV", "T_POW", "T_NEWLINE", "LPAREN", "RPAREN",
...
#line 44 "example.y"
                           { printf("\tResult: %i\n", (yyvsp[-1].ival)); }
#line 1094 "example.tab.c"
    break;

  case 6: /* expression: T_INT  */
#line 55 "example.y"
                                                { (yyval.ival) = (yyvsp[0].ival); }
#line 1100 "example.tab.c"
    break;
